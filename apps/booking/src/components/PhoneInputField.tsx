...
export const PhoneInputField: React.FC<PhoneInputFieldProps> = ({
  ...
  const [selectedCountry, setSelectedCountry] = useState<CountryCode>(() => {
    return detectCountryFromPhone(value, getStudioCountry());
  });
  ...
  return (
    <div className="space-y-1.5 group">
      ...
      <div className={`relative flex items-center bg-zinc-950/60 border-2 rounded-xl transition-all duration-300 ${
