...
export function SiteShell({
  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-x-hidden bg-[#050505] font-sans text-white selection:bg-[#FFBE4E]/30">
      {/* ambient backdrop */}
      <div className="pointer-events-none fixed inset-0 z-0" aria-hidden="true">
        <div className="absolute left-[-5%] top-[-5%] h-[30%] w-[30%] rounded-full bg-[#FFBE4E]/5 blur-[100px]" />
        <div className="absolute bottom-[-5%] right-[-5%] h-[30%] w-[30%] rounded-full bg-[#FFBE4E]/5 blur-[100px]" />
        {vignette && (
