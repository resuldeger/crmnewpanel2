...
export default function EntitySubView({
  ...
  return (
    <div className="space-y-4 animate-rise">
      ...
      {play && <PlayerModal callId={play.id} durationHint={play.duration} result={play.result} title={play.direction === "inbound" ? play.fromName : play.toName} subtitle={`${play.ext} · ${fmtDT(play.startTime)}`} onClose={() => setPlay(null)} />}
      {smsOpen && parentPhone && (
        <SmsCompose
